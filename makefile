CC=g++
CPPFLAGS= -O3 -lpthread -fsanitize=address -mfpmath=sse -fstack-protector-all -g -W -Wall -Wextra -Wunused -Wcast-align -Werror -pedantic -pedantic-errors -Wfloat-equal -Wpointer-arith -Wformat-security -Wmissing-format-attribute -Wformat=1 -Wwrite-strings -Wcast-align -Wno-long-long -Woverloaded-virtual -Wnon-virtual-dtor -Wcast-qual -Wno-suggest-attribute=format

all: hello

hello: main.o function.o text.o print.o vector.o solution.o norma.o accuracy.o synchronize.o
	$(CC) $(CPPFLAGS) main.o function.o text.o print.o vector.o solution.o norma.o synchronize.o accuracy.o
